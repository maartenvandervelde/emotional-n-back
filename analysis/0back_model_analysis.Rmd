...
acc_aov <- aov_ez(id = "id", dv = "accuracy", data = behdat_filtered, between = "type", within = c("stimulus", "expected_response"))
acc_aov
...
### ANOVA
```{r}
rr_aov <- aov_ez(id = "id", dv = "responded", data = behdat, between = "type", within = c("stimulus", "expected_response"))
rr_aov
...
### ANOVA
```{r}
rt_aov <- aov_ez(id = "id", dv = "rt", data = behdat_filtered, between = "type", within = c("stimulus", "expected_response"))
rt_aov
...
### ANOVA
```{r}
zrt_aov <- aov_ez(id = "id", dv = "z_rt", data = behdat_filtered_z_rt, between = "type", within = c("stimulus", "expected_response"))
zrt_aov
